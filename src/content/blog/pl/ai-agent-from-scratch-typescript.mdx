...
description: "Dogłębne spojrzenie na budowę prawdziwego agenta AI od zera w TypeScript - bez LangChain, bez CrewAI, tylko pętla, API OpenAI i kilka małych bibliotek. Poznaj architekturę, decyzje i lekcje, które frameworki przed Tobą ukrywają."

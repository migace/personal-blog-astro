...
<Image src="/local-execution-vs-centralization.webp" alt="Diagram comparing local CLI execution with centralized MCP service boundaries" width={1400} height={871} />
